...
const products = [
    ...
    {id: "2", name: "HeadPhones Bluetooth Marshall", price: 700, category: "Inalambricos", Image: "../imagenes/marshall.jpeg", description: " Amplifican el audio mientras cancelan ruido exterior. Lleve el gran escenario en su bolsillo con 20 horas totales de reproducción inalámbrica y el resistente estuche de carga portátil." , stock: "30 unidades disponibles"},
